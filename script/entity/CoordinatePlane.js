...
define('CoordinatePlane', ['ClassHelper'], function (ClassHelper) {
  ...
  CoordinatePlane.prototype = {
    ...
    draw: function draw() {
      ...
      this.gl.disableVertexAttribArray(this.shaderProgram.textureCoordAttribute); //this.gl.vertexAttribPointer(this.shaderProgram.vertexNormalAttribute, 1, this.gl.FLOAT, false, 0, 0);
      ...
      this.gl.bindBuffer(this.gl.ELEMENT_ARRAY_BUFFER, this.lineVertexIndexBuffer);
      this.setMatrixUniforms(); //this.gl.drawArrays(this.gl.LINES, 0, this.cubeVertexPositionBuffer.numItems);
