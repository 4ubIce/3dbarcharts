...
define('CoordinatePlaneText', ['CoordinatePlane', 'Character', 'ClassHelper', 'MatrixStack'], function (CoordinatePlane, Character, ClassHelper, MatrixStack) {
  ...
  CoordinatePlaneText.prototype = {
    ...
    init: function init() {
      var xTexture, yTexture, zTexture;
      ...
      for (var i = 0; i < posX * yTicksCount + posY * xTicksCount; i++) {
        ...
        zTexture = 0;
        var axisChar = new Character(this.gl, this.shaderProgram, this.mvMatrix, {
          x: xTexture,
          y: yTexture,
          z: zTexture,
          text: {
          ...
          rotate: textRotate,
          xRotation: textxRotation,
          yRotation: textyRotation,
          zRotation: textzRotation
        }).init();
